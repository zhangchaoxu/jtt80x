...
public class JT809Constants {
     ...
     * 主链路注销请求消息
     */
    public static int UP_DICONNECE_REQ = 0x1003;
    /**
     * 主链路注销应答消息
     */
    public static int UP_DISCONNECT_RSP = 0x1004;
    /**
     * 主链路连接保持请求消息
     */
     ...
     * 主链路断开通知消息
     */
    public static int UP_DISCONNECT_INFORM = 0x1007;
    /**
     * 下级平台主动关闭链路通知消息
     */
    public static int UP_CLOSELINK_INFORM = 0x1008;
    /**
     * 从链路连接请求消息
     */
     ...
     * 从链路注销请求消息
     */
    public static int DOWN_DISCONNECT_REQ = 0x9003;
    /**
     * 主链路车辆动态信息交换消息
     */
     ...
     * 从链路动态信息交换消息
     */
    public static int DOWN_EXG_MSG = 0x9200;
